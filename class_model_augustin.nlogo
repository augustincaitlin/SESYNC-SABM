...
;;modifcation introduced in this block
to move-turtles
  ask turtles [
    ifelse energy < energy-from-grass
    [left random 180 back 1 set energy energy - 1]
    [right random 180 forward 1 set energy energy - 1]
  ]
end
